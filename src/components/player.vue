  ...
  >
      ...
      <v-col cols="12">
        <v-card v-if="currentTrack && currentTrack.album" color="primaryLight">
          <div class="d-flex flex-no-wrap justify-left">
            ...
            <div>
              <v-card-title
                style="font-size: 14px !important; line-height: 14px;"
                class="headline"
              ...
              <v-card-subtitle style="font-size: 12px;"
                ...
                <v-icon style="font-size: 9px; padding: 0 5px;"
    ...
    <v-row style="margin-bottom: -10px;">
      ...
      >
        ...
        >
          <template v-slot:prepend id="song">
            <v-btn
              v-on:click="volume === null ? updateVolume(100) : updateVolume(0)"
              height="27"
              width="27"
              color="secondary"
              icon
              ><v-icon>{{
                volume != null ? "mdi-volume-high" : "mdi-volume-off"
              }}</v-icon></v-btn
            >
          </template>
        </v-slider>
      ...
      >
        <v-btn
          v-on:click="prev"
          :disabled="player.disallows.skipping_prev"
          icon
          min-height="45"
          min-width="45"
        >
        ...
        <v-btn
          ...
          min-height="45"
          v-if="player.paused"
          :disabled="player.disallows.skipping_resuming"
          v-on:click="resumed()"
        >
          <v-icon color="secondary" style="font-size: 35px;"
        ...
        <v-btn
          ...
          min-height="45"
          v-if="!player.paused"
          :disabled="player.disallows.skipping_pausing"
          v-on:click="paused()"
        >
          <v-icon color="secondary" style="font-size: 35px;"
        ...
        <v-btn
          ...
          min-width="45"
          min-height="45"
          :disabled="player.disallows.skipping_next"
          v-on:click="next"
        >
